...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    // The DashboardViewModel is already initialized by the ChangeNotifierProvider in main.dart
                    ...
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: viewModel.isLoading
                            ? null
                            : (_) => viewModel.toggleOnlineStatus(),
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const SalesAnalyticsScreen(), // Placeholder
                ),
              );
            },
          ),
