...
import 'package:zenzio_restaurant/views/orders/order_details_screen.dart';
    ...
    switch (order.status) {
      ...
      case 'Ready':
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              viewModel.updateOrderStatus(order.id, 'Completed'); // Assuming 'Completed' means dispatched for now
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: AppColors.primary,
            ),
