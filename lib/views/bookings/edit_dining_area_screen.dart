...
import 'package:zenzio_restaurant/widgets/custom_textfield.dart';
...
class EditDiningAreaScreen extends StatefulWidget {
  final DiningSpace? diningSpace;

  const EditDiningAreaScreen({Key? key, this.diningSpace}) : super(key: key);

  @override
  State<EditDiningAreaScreen> createState() => _EditDiningAreaScreenState();
}

class _EditDiningAreaScreenState extends State<EditDiningAreaScreen> {
