...
import 'package:zenzio_restaurant/views/profile/bank_details_screen.dart';
import 'package:zenzio_restaurant/views/profile/change_password_screen.dart';
import 'dart:convert'; // 👈 for Base64 decoding
import 'package:zenzio_restaurant/views/profile/edit_restaurant_profile_screen.dart';
import 'package:zenzio_restaurant/views/profile/manage_operational_hours_screen.dart';
import 'package:zenzio_restaurant/views/profile/delivery_areas_screen.dart';
import 'package:zenzio_restaurant/views/profile/my_subscription_screen.dart';
import 'package:zenzio_restaurant/views/profile/notifications_screen.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  ImageProvider _getLogoImage(List<String>? photoList) {
    // photoList is now List<String>
    final String? logo = photoList?.isNotEmpty == true ? photoList!.first : null;
    if (logo == null || logo.isEmpty) {
      return const AssetImage('assets/images/restaurant_logo.png');
    }

    // Currently, only NetworkImage is handled for a URL
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: _getLogoImage(_restaurant?.photo),
                              fit: BoxFit.cover,
                            ),
                            border: Border.all(
                  ...
                  _SettingsMenuItem(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ManageOperationalHoursScreen(),
                        ),
                      );
                    },
                  ),
                  _SettingsMenuItem(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DeliveryAreasScreen(),
                        ),
                      );
                    },
                  ),
