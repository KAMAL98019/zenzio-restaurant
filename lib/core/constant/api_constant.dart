class ApiConstants {
  ...
  static const String loginOtpVerify = '/restaurants/auth/login/otp';
  ...
  static String toggleRestaurantActiveStatus(String id) =>
  ...
  static String restaurantMenuUploadImage(String uid) =>
      '/restaurant-menu/upload-image/$uid';
  static String restaurantMenuToggle(String id) => '/restaurant-menu/$id/toggle';
  static String restaurantMenuDeactivate(String id) => '/restaurant-menu/$id/deactivate';
  static String restaurantMenuActivate(String id) => '/restaurant-menu/$id/activate';
  static const String restaurantEnums = '/restaurant_enum';
  static const String s3MenuImageBaseUrl =
      'https://s3-demo-bucket-zenzio.s3.eu-north-1.amazonaws.com/images/menu/';
